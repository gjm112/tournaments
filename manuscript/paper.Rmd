...
$$
I^m_w(r,\hat{r})= \sum_{r}\sum_{\hat{r}}w(r, \hat{r}, m)p(r,\hat{r})\log \frac {p(r,\hat{r})}{p(r)p(\hat{r})}
$$
.

If we choose to use the weighted Kendall's $\tau$ for our weights, $w(r, \hat{r}, m)$ would be: 
...
$$
\frac{I^m_w(r,\hat{r})}{\text{max}\{H(r), H(\hat{r})\}}
$$
