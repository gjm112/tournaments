...
$$
w(\hat{r}_{\{{i|m_i >0}\}}, r_{\{{i|m_i >0}\}}) = \sum_{i = 1}^n m_i \times d(\hat{r}_i, r_i)

\\

wI_m(r_{\{{i|m_i >0}\}}, \hat{r_{\{{i|m_i >0}\}}})=\sum_{r_{\{{i|m_i >0}\}}}\sum_{\hat{r}_{\{{i|m_i >0}\}}} w(\hat{r}_{\{{i|m_i >0}\}}, r_{\{{i|m_i >0}\}}) \times \\
p(\hat{r}_{\{{i|m_i >0}\}}, r_{\{{i|m_i >0}\}})\times \\ \log \frac {p(\hat{r}_{\{{i|m_i >0}\}}, r_{\{{i|m_i >0}\}})}{p(r_{\{{i  \mid m_i >0}\}})p(\hat{r}_{\{{i \mid m_i >0}\}})}
$$
