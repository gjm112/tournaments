...
@Slater1961 addresses inconsistencies in pairwise comparisons by determining how many circular triads are possible while keeping the ranking valid. He provides a method for identifying and minimizing circular triads when ranking objects, known as the Slater rule. NEED TO FINISH
