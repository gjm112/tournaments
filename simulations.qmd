...
combined_plot_df <- combined_plot_df %>%
  mutate(
    color_group = case_when(
      ...
      tournament_type == "stagedRR" ~ "stagedRR (4 Groups)",
      tournament_type == "tennisLadder" ~ "tennisLadder (15 Rounds)",
...
combined_combinations_plot <- ggplot(combined_combinations_df, aes(x = index, y = mi_values, color = color_group, group = dataset)) +
  geom_line(linewidth = 1) +
  geom_point(size = 1.5) +
  facet_grid(
    ~ distribution,
...
single_elimination_combinations_noties_plot <- ggplot(single_elim_combinations_noties_df, aes(x = index, y = mi_values, color = color_group, group = dataset)) +
  geom_line(linewidth = 1) +
  geom_point(size = 1.5) +
  facet_grid(
    series ~ distribution,
...
single_elimination_combinations_ties_plot <- ggplot(single_elim_combinations_ties_df, aes(x = index, y = mi_values, color = color_group, group = dataset)) +
  geom_line(linewidth = 1) +
  geom_point(size = 1.5) +
  facet_grid(
    series ~ distribution,
...
double_elimination_plot_df <- double_elimination_plot_df %>%
  select(-any_of(c("tournament_type", "distribution", "ties", "series", "bad_seeding", "param_label", "color_group"))) %>%
  group_by(dataset) %>%
  mutate(
...
double_elimination_plot_df <- double_elimination_plot_df %>%
   mutate(
    color_group = paste(tournament_type, bad_seeding, sep = " | ")
  )
...
# Plot 1: No Ties (Combinations)
double_elimination_combinations_noties_plot <- ggplot(double_elimination_combinations_plot_noTies_df, aes(x = index, y = mi_values, color = color_group, group = dataset)) +
  geom_line(linewidth = 1) +
  geom_point(size = 1.5) +
  facet_grid(
    series ~ distribution,
...
# Plot 2: Ties (Combinations)
double_elimination_combinations_ties_plot <- ggplot(double_elimination_combinations_plot_ties_df, aes(x = index, y = mi_values, color = color_group, group = dataset)) +
  geom_line(linewidth = 1) +
  geom_point(size = 1.5) +
  facet_grid(
    series ~ distribution,
...
# Plot 1: No Ties (Combinations)
group_stage_combinations_noties_plot <- ggplot(group_stage_combinations_noties_df, aes(x = index, y = mi_values, color = color_group, group = dataset)) +
  geom_line(linewidth = 1) +
  geom_point(size = 1.5) +
  facet_grid(
    series ~ distribution,
...
# Plot 2: Ties (Combinations)
group_stage_combinations_ties_plot <- ggplot(group_stage_combinations_ties_df, aes(x = index, y = mi_values, color = color_group, group = dataset)) +
  geom_line(linewidth = 1) +
  geom_point(size = 1.5) +
  facet_grid(
    series ~ distribution,
...
# Plot 1: No Ties
staged_rr_noties_plot <- ggplot(staged_rr_noties_df, aes(x = index, y = mi_values, color = color_group, group = dataset)) +
  geom_line(linewidth = 1) +
  geom_point(size = 1.5) +
  facet_grid(
    series ~ distribution,
...
# Plot 2: Ties
staged_rr_ties_plot <- ggplot(staged_rr_ties_df, aes(x = index, y = mi_values, color = color_group, group = dataset)) +
  geom_line(linewidth = 1) +
  geom_point(size = 1.5) +
  facet_grid(
    series ~ distribution,
...
# Plot 1: No Ties (Combinations)
staged_rr_combinations_noties_plot <- ggplot(staged_rr_combinations_noties_df, aes(x = index, y = mi_values, color = color_group, group = dataset)) +
  geom_line(linewidth = 1) +
  geom_point(size = 1.5) +
  facet_grid(
    series ~ distribution,
...
# Plot 2: Ties (Combinations)
staged_rr_combinations_ties_plot <- ggplot(staged_rr_combinations_ties_df, aes(x = index, y = mi_values, color = color_group, group = dataset)) +
  geom_line(linewidth = 1) +
  geom_point(size = 1.5) +
  facet_grid(
    series ~ distribution,
...
# Plot 1: Good Seed
tennis_ladder_goodseed_plot <- ggplot(tennis_ladder_goodseed_df, aes(x = index, y = mi_values, color = color_group, group = dataset)) +
  geom_line(linewidth = 1) +
  geom_point(size = 1.5) +
  facet_grid(
...
# Plot 2: Bad Seed
tennis_ladder_badseed_plot <- ggplot(tennis_ladder_badseed_df, aes(x = index, y = mi_values, color = color_group, group = dataset)) +
  geom_line(linewidth = 1) +
  geom_point(size = 1.5) +
  facet_grid(
    rounds_factor ~ distribution,
...
tennis_ladder_combinations_goodseed_plot <- ggplot(tennis_ladder_combinations_goodseed_df, aes(x = index, y = mi_values, color = color_group, group = dataset)) +
  geom_line(linewidth = 1) +
  geom_point(size = 1.5) +
  facet_grid(
    rounds_factor ~ distribution,
...
tennis_ladder_combinations_badseed_plot <- ggplot(tennis_ladder_combinations_badseed_df, aes(x = index, y = mi_values, color = color_group, group = dataset)) +
  geom_line(linewidth = 1) +
  geom_point(size = 1.5) +
  facet_grid(
    rounds_factor ~ distribution,
