...
knitr::include_graphics("Weighted_Mutual_Information_Formula.png")
```
...
knitr::include_graphics("Top_2_Kendall.png")
```
:::
::: {.fragment .fade-in fragment-index="1" style="position: absolute; width: 100%;"}
```{r out.width="100%", fig.show='hold', fig.align='center'}
knitr::include_graphics("Top_3_Kendall.png")
```
:::
::::::
...
:::::: {style="position: relative; display: flex; align-items: center; justify-content: center; height: 100%;"}
::: {.fragment .fade-out fragment-index="1" style="position: absolute; width: 100%;"}
```{r out.width="125%", fig.show='hold', fig.align='center'}
