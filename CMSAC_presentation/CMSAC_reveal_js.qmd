...
-   **Efficacy**[^1]: Final rankings should match the true rankings of all the competitors
...
-   The final metric we used normalizes the results: $\frac{wI_m(r,\hat{r})}{H(r,\hat{r})}$
