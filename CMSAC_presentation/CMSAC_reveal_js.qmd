...
-   Which competition structure is best?
    ...
    - A good tournament: top *k* produced by the tournament matches closely to the true top *k* 
...
::: {.fragment}
-   **Salient ranks**: output ranks of the competition you want to get correct
    -   Effectivity: 1 is only salient rank
    -   Efficacy: 1 through $n$ are salient ranks
:::

## Goal

-   Want to quantify how well a structure can accurately order the competitors
-   We propose a metric that quantifies how effectively different competition structures recover the true ranking
