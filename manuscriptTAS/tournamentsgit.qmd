...
![This figure compares the normalized weight mutual information of
various round robin competition structures against the number of salient
...
-   estimating the strength parameters for many seasons, running
    simulations for each of those seasons, combining the results and
    using the formula to get an overall mutual information score
...
-   estimating the strength parameters for many seasons and averaging
    the strength parameter associate by the order of competitors (e.g.
    average the best team from each season), running simulations over
    the new strength distribution from the averages.
