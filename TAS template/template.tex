...
\item
  ...
  separate files.
\item
  In document preamble, you may set the key \texttt{anon} to ``0'' to hide the authors and acknowledgements,
  producing the required anonymized version. Set the key \texttt{anon} to ``1'' to produce the manuscript with author details and acknowledgments. 
\item
...
have about 26 lines per page.} The quick brown fox jumped over the lazy dog.
The quick brown fox jumped over the lazy dog. The quick brown fox jumped
over the lazy dog. The quick brown fox jumped over the lazy dog. The
